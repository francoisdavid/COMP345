...
Card::Card(int index){
    ...
    switch(index){
        ...
        case 4: goods = "Forest"; action = "Destroy 1 army or Build City."; break;
        case 5: goods = "Forest"; action = "Add 2 armies or Move 3 Armies." ; break;
        case 6: goods = "Forest"; action = "Move 4 armies via Ship."; break;
        case 7: goods = "Forest"; action = "Build city."; break;
        case 8: goods = "Forest"; action = "Move 3 armies via Ship."; break;
        
        // 10 Carrots cards.
         case 9: goods = "Carrots"; action = "Build city."; break;
        case 10: goods = "Carrots"; action = "Destroy 1 army & Add 1 City."; break;
        case 11: goods = "Carrots"; action = "Add 3 armies."; break;
        case 12: goods = "Carrots"; action = "Move 4 armies."; break;
        case 13: goods = "Carrots"; action = "Move 5 armies."; break;
        case 14: goods = "Carrots"; action = "Add 3 armies."; break;
        case 15: goods = "Carrots"; action = "Move 3 armies via Ship."; break;
        case 16: goods = "Carrots"; action = "Move 4 armies or move 2 armies."; break;
        case 17: goods = "Carrots"; action = "Move 4 armies."; break;
        case 18: goods = "Carrots"; action = "Build City."; break;
        
        // 9 Anvil cards.
        case 19: goods = "Anvil"; action = "Move 4 armies."; break;
        case 20: goods = "Anvil"; action = "Move 3 armies or move 4 armies."; break;
        case 21: goods = "Anvil"; action = "Move 5 armies.";break;
        case 22: goods = "Anvil"; action = "Add 3 armies."; break;
        case 23: goods = "Anvil"; action = "Add 3 armies."; break;
        case 24: goods = "Anvil"; action = "Move 3 armies via Ship."; break;
        case 25: goods = "Anvil"; action = "Build city."; break;
        case 26: goods = "Anvil"; action = "Move 4 armies."; break;
        case 27: goods = "Anvil"; action = "Add 3 armies or move 3 armies."; break;
        
        // 7 Ore cards.
        case 28: goods = "Ore"; action = "Move 2 armies."; break;
        case 29: goods = "Ore"; action = "Move 3 armies via Ship."; break;
        case 30: goods = "Ore"; action = "Move 2 armies via Ship."; break;
        case 31: goods = "Ore"; action = "Move 3 armies via Ship."; break;
        case 32: goods = "Ore"; action = "Add 3 armies."; break;
        case 33: goods = "Ore"; action = "Add 3 armies."; break;
        case 34: goods = "Ore"; action = "Add 2 armies."; break;
            
        // 5 Crystal cards.
        case 35: goods = "Crystal"; action = "Add 2 armies.";break;
        case 36: goods = "Crystal"; action = "Add 2 armies.";break;
        case 37: goods = "Crystal"; action = "Move 2 armies.";break;
        case 38: goods = "Crystal"; action = "Add 1 army.";break;
        case 39: goods = "Crystal"; action = "Add 2 armies.";break;
            
        // 3 Wild cards.
        case 40: goods = "Wild"; action = "Move 2 armies.";break;
        case 41: goods = "Wild"; action = "Move 2 armies.";break;
